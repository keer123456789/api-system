package com.keer.underline.generator;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://152.136.60.106:8001/under_line?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","123456")
         ...
         * 全局配置
         */
        String projectPath = System.getProperty("user.dir")+"/underline"; //获取项目路径
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.keer.underline")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
